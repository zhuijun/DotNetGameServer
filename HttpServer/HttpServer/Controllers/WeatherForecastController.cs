...
namespace HttpServer.Controllers
{
    ...
    public class WeatherForecastController : ControllerBase
    {
        ...
        {
            var s = DateTime.Now.ToLocalTime();
            var text = "UserId=13674&Type=0&Value=100&Timestamp=1616060597&Remark=test";
            //2048 私钥
            string privateKey =
            ...
            //私钥签名
            string signStr = rsa.Sign(text);

            RecordUserPointDetailReq req = new RecordUserPointDetailReq { UserId = 13674, Type = 0, Value = 100, Timestamp = 1616060597, Remark = "test", Sign = signStr };
            ...
            var response = await client.PostAsync("http://localhost:60001/api/Record/AddUserPoint", todoItemJson);
